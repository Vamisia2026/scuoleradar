/* Invita un Collega — ribbon + anteprima disabilitata.
   Uso: node scripts/_invita.mjs */
...
console.log('  ✓ InvitaPage: ribbon IN ARRIVO A NOVEMBRE + anteprima disabilitata');
