...
export const interpelli: Interpello[] = [
  {
    ...
    descrizione:
      'Si ricerca docente per copertura supplenza annuale per la classe di concorso A-27. Posizione a tempo pieno, inserimento in organico di diritto. Richiesta abilitazione specifica.',
  ...
  },
  {
    ...
    descrizione:
      'Supplenza per classe A-28 presso scuola secondaria di I grado. Si richiede abilitazione e disponibilità al trasferimento.',
  ...
  },
  {
    ...
    descrizione:
      'Interpello per classe A-19. Posizione fino al termine delle lezioni. Richiesta titolo di accesso.',
  ...
  },
  {
    ...
    descrizione:
      'Ricerca docente A-50 per supplenza annuale. Laboratori di chimica e biologia disponibili presso l\'istituto.',
  ...
  },
  {
    ...
    descrizione:
      'Supplenza per classe A-01. Atelier e laboratori attrezzati. Possibilità di collaborazione a progetti espositivi.',
  ...
  },
  {
    ...
    descrizione:
      'Interpello per classe A-30. Sala musica e strumenti disponibili. Supplenza fino a fine anno scolastico.',
  ...
  },
  {
    ...
    descrizione:
      'Ricerca docente A-24 per supplenza annuale. Scambi culturali con istituti partner in Francia.',
  ...
  },
  {
    ...
    descrizione:
      'Supplenza per classe A-20. Laboratorio di fisica moderno. Possibilità di partecipare a progetti PCTO.',
  ...
  },
  {
    ...
    descrizione:
      'Interpello per classe A-11 presso liceo classico. Richiesta abilitazione.',
  ...
  },
  {
    ...
    descrizione:
      'Ricerca docente A-46 per supplenza annuale. Indirizzo AFM. Possibilità di collaborazione con enti del territorio.',
  ...
  },
  {
    ...
    descrizione:
      'Interpello per classe B-12. Laboratorio chimico attrezzato. Supplenza fino al termine delle attività.',
  ...
  },
  {
    ...
    dataScadenza: giorni(2),
    descrizione:
      'Ricerca docente A-22 per supplenza annuale presso scuola secondaria di I grado (spagnolo).',
  ...
  },
  {
    ...
    dataScadenza: giorni(1),
    descrizione:
      'Supplenza per classe A-22. Progetti CLIL e gemellaggi con scuole europee. Disponibilità immediata.',
