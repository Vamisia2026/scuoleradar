 ...
 * Conformi a docs/BLOG_EDITORIAL_GUIDELINES.md (zero rumore, riferimenti
 * ufficiali, link di profondità validati, niente root-domain generici).
 *
