...
export type TabAdmin = 'utenti' | 'radar' | 'email' | 'account' | 'dipartimenti';
 ...
 *
 * La whitelist vive in `@/lib/utentiAdmin` (unica fonte di verità, condivisa con
 * le feature flags e con il gate delle notifiche) e viene ri-esportata qui per
 * non cambiare l'API pubblica del dipartimento Admin.
 */
export { ADMIN_EMAILS, EMAIL_ADMIN_TEST, eEmailAdmin } from '@/lib/utentiAdmin';
