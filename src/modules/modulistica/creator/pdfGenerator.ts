...
const STILI_DOCUMENTO = `
  ...
  * { box-sizing: border-box; }
  ...
  .righe-scrittura { margin: 0 0 8px; }
  .righe-scrittura div {
    height: 24px;
  ...
  body.layout-compatto h2 { margin: 6px 0 3px; }
  body.layout-compatto .crocette { padding: 4px 6px; }
  body.layout-compatto .intestazione-formale td,
  body.layout-compatto .quadro-anagrafico td { padding: 3px 5px; }
  ...
  body.layout-compatto .scrittura-mano { min-height: 56px; }
  body.layout-compatto .scrittura-mano--media { min-height: 64px; }
  body.layout-compatto .scrittura-mano--alta { min-height: 80px; }
